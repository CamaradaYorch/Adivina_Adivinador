...
class Adivina_Adivinador_v1:
    ...
    def __init__(self):
        ...
        # ► Lista de letras adivinadas por el jugador
...
#------------------------------------------------------------------
    ...
    def adivinar_palabra(self, palabra):
        ...
        if palabra == self.color_oculto:
            print("😃 ⭐⭐⭐ ¡Felicidades! Adivinaste el color. (ﾉ☉ヮ⚆)ﾉ ⌒*:･ﾟ⭐⭐⭐")
            return True
        else:
            self.intentos_restantes -= 1
